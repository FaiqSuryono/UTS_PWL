...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>assets/index2.html" class="logo">
      ...
      <span class="logo-lg"><b>BookingFutsal</b></span>
    </a>
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url(); ?>assets/dist/img/f.jpg" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url(); ?>assets/dist/img/f.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Faiq Suryono</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
              <li class="user-header">
                ...
                <p>
                  Faiq Suryono - Web Developer
                  <small>Member since mei. 2020</small>
                </p>
              </li>
              <!-- Menu Body -->
              <li class="user-body">
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview">
          <a href="#">
            <i class="fa fa-table"></i> <span>BOOKING LAPANGAN</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
            <li><a href="../tables/simple.html"><i class="fa fa-circle-o"></i> Customer</a></li>
            <li><a href="../tables/data.html"><i class="fa fa-circle-o"></i> Pemesanan</a></li>
            <li><a href="../tables/data.html"><i class="fa fa-circle-o"></i> Lapangan</a></li>
          </ul>
        </li>
        <li>
          <a href="">
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h3>
        Welcome to Booking Futsal
        <small>Fair Play</small>
      </h3>
      <ol class="breadcrumb">
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2020 <a href="https://adminlte.io">Faiq Suryono_181240000757</a>.</strong> All rights
    reserved.
  </footer>
